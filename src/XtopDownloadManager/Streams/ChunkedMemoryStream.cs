...
// Modified by Ramtin Jokar [ Ramtin Jokar ]
// System.Memory package required for .NET Standard
...
namespace XtopDownloadManager.Streams
{
#if !NETSTANDARD
#nullable enable
#endif
    ...
    internal sealed class ChunkedMemoryStream : Stream
    {
        ...
        public byte[] ToArray()
        {
            ...
            int offset = 0;
            for (var chunk = _headChunk; chunk != null; chunk = chunk._next)
            {
