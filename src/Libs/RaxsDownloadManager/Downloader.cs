...
using RaxsDownloadManager.Exceptions;
using RaxsDownloadManager.Storage;
using RaxsDownloadManager.Downloads;
using static RaxsDownloadManager.Downloads.HttpHelper;
